<template>
  ...
  <div class="pt-10 flex flex-col md:flex-row gap-5">
    ...
    <div class="">
      ...
      <div v-if="notFound" class="text-xl mt-5 text-darkBlue">На жаль, за даним запитом результатів не знайдено :(</div>
      <ul v-else class="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-4 mt-5" v-auto-animate>
...
const { books, isLoading, notFound } = storeToRefs(store);
</script>